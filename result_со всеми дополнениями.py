...
import pygame_menu
# импортируем функцию для засекания времени, чтобы интерпретатор не искал эту функцию в pygame модуле time, даем ей другое название сами
...
def reload_the_game():
    global finish,score,lost,num_fire,life,menu
    menu.disable()
    finish = False
    score = 0
    lost = 0
...
menu = pygame_menu.Menu('SHOOTER', 400, 300,
                       theme=pygame_menu.themes.THEME_BLUE)


menu.add.button('Reload', reload_the_game)
